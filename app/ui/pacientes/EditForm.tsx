import {
    ...
    fetchProvincias,
    fetchCantones,
    fetchDistritos, fetchPacientesById
} from "@/app/lib/data";
import {editPaciente, setId} from "@/app/lib/actions";



export async function EditForm({id}:{id:number}) {
    const paciente = await fetchPacientesById(id);
 ...
 return (
     <form action={editPaciente} className="space-y-4">
         <div>
             ...
             <input
                 ...
                 defaultValue={paciente[0].NOMBRE_COMPLETO}
         ...
         <div>
             ...
             <input
                 ...
                 defaultValue={paciente[0].NUMERO_PACIENTE}
         ...
         <div>
             ...
             <input
                 ...
                 defaultValue={paciente[0].CORREO_PACIENTE}
                 className="mt-1 mr-1 block w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500"
             />
         </div>
         <div>
